  ...
  return (
    <div className="bg-primary w-full overflow-hidden">
      ...
      <div className="flex md:flex-row flex-col items-start">
        <div
          className={`flex xs:flex-col xs:justify-start sm:flex-row sm:justify-between  md:flex-col
       ${styles.marginY}`}
        >
          <LeftNavbar />
          <LeftButton />
        ...
        <div
          className={`flex flex-wrap justify-left items-center ${styles.sectionXY} bg-secondary`}
        >
          <Switches />
